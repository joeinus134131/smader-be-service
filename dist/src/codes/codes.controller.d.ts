...
export declare class CodesController {
    ...
    create(createCodeDto: any): import("@prisma/client").Prisma.Prisma__CodeClient<{
        id: string;
        fingerCount: number;
        meaning: string;
        urgencyLevel: string;
    ...
    update(id: string, updateCodeDto: any): import("@prisma/client").Prisma.Prisma__CodeClient<{
        id: string;
        fingerCount: number;
        meaning: string;
        urgencyLevel: string;
